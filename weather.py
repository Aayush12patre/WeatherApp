...
def getWeather():
    try:
        city = textfield.get()
        geolocator = Nominatim(user_agent="Weather App", timeout=9)
        ...
        #Weather
        api = "https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=9b29967375a894d3f129b68c6e1019b7"
...
#TIME
name = Label(root, font=("aril", 15, "bold"))
